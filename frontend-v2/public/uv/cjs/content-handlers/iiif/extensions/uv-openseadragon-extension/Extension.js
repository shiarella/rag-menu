...
var OpenSeadragonExtension = /** @class */ (function (_super) {
    ...
    OpenSeadragonExtension.prototype.getCroppedImageUri = function (canvas, viewer) {
        ...
        var quality = "default";
        return "".concat(baseUri, "/").concat(id, "/").concat(region, "/").concat(size, "/").concat(rotation, "/").concat(quality, ".jpg");
    };
    OpenSeadragonExtension.prototype.getConfinedImageDimensions = function (canvas, longestSide) {
