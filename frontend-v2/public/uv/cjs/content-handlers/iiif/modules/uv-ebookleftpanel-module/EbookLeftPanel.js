            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        this.extensionHost.subscribe(Events_1.EbookExtensionEvents.LOADED_NAVIGATION, function (navigation) {
                            _this.$main.removeClass("disabled");
                            _this._ebookTOC.toc = navigation.toc;
                        });
                        this.extensionHost.subscribe(Events_1.EbookExtensionEvents.RELOCATED, function (location) {
                            _this._ebookTOC.selected = location.start.href;
                        });
                        this._ebookTOC.addEventListener("itemClicked", function (e) {
                            _this.extensionHost.publish(Events_1.EbookExtensionEvents.ITEM_CLICKED, e.detail);
                        ...
                        utils_1.Async.waitFor(function () {
                            ...
                            customElements.whenDefined("uv-ebook-toc").then(function () {
                                _this.extensionHost.publish(Events_1.EbookExtensionEvents.TOC_READY);
                            });
                        });
                        return [2 /*return*/];
                }
