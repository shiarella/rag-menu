...
var MediaElementCenterPanel = /** @class */ (function (_super) {
    ...
    MediaElementCenterPanel.prototype.isTypeMedia = function (element) {
        var type = element.getFormat();
        if (type === null) {
            return false;
        }
        var typeStr = type.toString();
        var typeGroup = typeStr.split("/")[0];
        return typeGroup === "audio" || typeGroup === "video";
    };
    // vtt, srt, csv
    MediaElementCenterPanel.prototype.isTypeCaption = function (element) {
        var type = element.getFormat();
        if (type === null) {
            return false;
        }
        var captionTypes = new Set(["text/vtt", "text/srt"]);
