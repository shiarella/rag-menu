...
var AVCenterPanel = /** @class */ (function (_super) {
    ...
    AVCenterPanel.prototype.create = function () {
        ...
        this.extensionHost.subscribe(IIIFEvents_1.IIIFEvents.RANGE_TIME_CHANGE, function (_a) {
            var time = _a.time, rangeId = _a.rangeId;
            _this._whenMediaReady(function () {
                if (_this.avcomponent) {
                    _this.avcomponent.setCurrentRangeTime(time, rangeId, true);
                }
            });
        });
