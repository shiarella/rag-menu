...
var Thumbnails = function (_a) {
    var onClick = _a.onClick, onKeyDown = _a.onKeyDown, paged = _a.paged, selected = _a.selected, thumbs = _a.thumbs, viewingDirection = _a.viewingDirection, truncateThumbnailLabels = _a.truncateThumbnailLabels;
    var ref = (0, react_1.useRef)(null);
    (0, react_1.useEffect)(function () {
        var _a, _b;
        var thumb = (_a = ref.current) === null || _a === void 0 ? void 0 : _a.querySelector("#thumb-".concat(selected[0]));
    ...
    return (react_1.default.createElement("div", { ref: ref, className: (0, classnames_1.default)("thumbs", {
            ...
            paged: paged,
            "truncate-labels": truncateThumbnailLabels,
        }) }, thumbs.map(function (thumb, index) { return (react_1.default.createElement("span", { key: "thumb-".concat(index), id: "thumb-".concat(index), className: "thumb-container" },
